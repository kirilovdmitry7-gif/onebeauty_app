...
abstract class AppLocalizations {
  ...
  /// No description provided for @aiAdviceToday.
  ///
  /// In en, this message translates to:
  /// **'Today’s tip'**
  String get aiAdviceToday;

  /// No description provided for @aiAdviceWeekly.
  ///
  /// In en, this message translates to:
  /// **'Weekly summary'**
  String get aiAdviceWeekly;

  /// No description provided for @aiAdviceNudge.
  ///
  /// In en, this message translates to:
  /// **'Reminder'**
  String get aiAdviceNudge;
